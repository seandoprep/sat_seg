...
def main(
    ...
    try:
        eval_dataset = SatelliteDataset(data_dir=data_dir, split="test", transform=custom_transform)
        test_dataloader = DataLoader(eval_dataset, batch_size=1, shuffle=False)
